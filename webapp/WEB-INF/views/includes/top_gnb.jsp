 <%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <a href="${pageContext.servletContext.contextPath }/search_employee" class="menu item_2"></a>
    <a href="${pageContext.servletContext.contextPath }/search_employee" class="menu item_3"></a>
